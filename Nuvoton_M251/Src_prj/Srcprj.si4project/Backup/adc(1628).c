...
/* EADC function test                                                                                       */
/*---------------------------------------------------------------------------------------------------------*/
uint_16 EADC_FunctionTest(uint_8 u32ChannelNum)
{
    uint_16 i32ConversionData;
	
	uint_16 u32IntNum,u32ModuleNum;
	uint_16 u32IntMask,u32ModuleMask;
 ...
 //   EADC_ENABLE_AVG(EADC, u32ModuleNum);
    ...
    EADC_ENABLE_INT(EADC, u32IntMask);//Enable sample module A/D ADINT0 interrupt.
